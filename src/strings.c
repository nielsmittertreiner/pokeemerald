...
const u8 gText_Healthbox[] = _("HEALTHBOX");
...
const u8 gText_HealthboxStatic[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}STATIC");
const u8 gText_HealthboxMove[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}MOVE");
