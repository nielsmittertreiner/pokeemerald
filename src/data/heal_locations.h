static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_SUNSET_TOWN - 1] = {MAP_GROUP(SUNSET_TOWN), MAP_NUM(SUNSET_TOWN), 5, 7},
    [HEAL_LOCATION_CEDARRED_TOWN - 1] = {MAP_GROUP(CEDARRED_TOWN), MAP_NUM(CEDARRED_TOWN), 5, 22},
    [HEAL_LOCATION_FIRWEALD_CITY - 1] = {MAP_GROUP(FIRWEALD_CITY), MAP_NUM(FIRWEALD_CITY), 11, 8},
    [HEAL_LOCATION_MURENA_CITY - 1] = {MAP_GROUP(MURENA_CITY), MAP_NUM(MURENA_CITY), 21, 10},
    [HEAL_LOCATION_LITOR_TOWN - 1] = {MAP_GROUP(LITOR_TOWN), MAP_NUM(LITOR_TOWN), 22, 19},
    [HEAL_LOCATION_NAVIRE_TOWN - 1] = {MAP_GROUP(NAVIRE_TOWN), MAP_NUM(NAVIRE_TOWN), 11, 16},
};
